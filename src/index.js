...
function applyTransformation(obj, fn) {
    return Object.entries(obj).reduce((acc, [k, v]) => ({ ...acc, [k]: fn(k, v) })
        , {})
}
...
function generateDataBinder(outputProto) {
    return (input) => {
        ...
        Object.defineProperty(output, DATA_ATTRIBUTE, { value: dataAttributeProxy(input) })
        return output
    }
}
